...
#The authors used a Kruskal-Wallis test rather than ANOVA to compare the strains because 
...
one.col <- lim_nologdata$Num.Cells.Progeny
hist(one.col, main = "")
fitdist(c(na.exclude(one.col)), dist = norm
